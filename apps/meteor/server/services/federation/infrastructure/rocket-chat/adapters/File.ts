...
export class RocketChatFileAdapter {
	...
	public async createRemoteFileReference(
		...
		// Create files and attachments for the message
		...
		// Create appropriate attachment based on file type
		const attachments: MessageAttachment[] = [];
		
		// For remote files, we use the MXC URI directly in the attachment
		// The UI will need to handle this via proxy
	...
	public async extractMetadataFromFile(file: IUpload): Promise<{ height?: number; width?: number; format?: string }> {
		// Skip metadata extraction for remote files
